...
<html>
	<head>
		...
		<script src="//api.map.baidu.com/api?type=webgl&v=1.0&ak=cAHcRY9KVFmGvymjpNeoPzNw4ehzimAd"></script>
	</head>
	<body>
	<!-- 将头部(_head.jsp)包含进来 -->
...
map.centerAndZoom(new BMapGL.Point(113.034993,23.152774), 17); // 初始化地图,设置中心点坐标和地图级别
map.enableScrollWheelZoom(true); // 开启鼠标滚轮缩放
var marker1 = new BMapGL.Marker(new BMapGL.Point(113.034993,23.152774));
