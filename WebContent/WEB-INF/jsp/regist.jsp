	...
	<head>
		...
		<script type="text/javascript">
			...
			$(function(){
				...
				$("input[name='emailvalistr']").blur(function(){
					formobj.checkNull("emailvalistr", "邮箱验证码不能为空！");
				});
				
				$("input[name='send_email_valistr']").click(function(){
					$.get("${ pageContext.request.contextPath }/user/send?email=" + $("input[name='email']").val(),function(data,status){
						
					});	
					console.log("${ pageContext.request.contextPath }/user/send?email=" + $("input[name='username']").val());
				});
			...
			var formobj={
				"checkForm":function(){
					...
					var res6=this.checkNull("emailvalistr", "邮箱验证码不能为空！")
					var res7=this.checkNull("valistr", "验证码不能为空！");
					var res8=this.checkPassword("password","两次密码输入不一致");
					var res9=this.checkEmail("email","邮箱格式不正确！");
			...
			<table>
				...
				<tr>
					...
					<td>
						...
						<input type="button" name="send_email_valistr" value="发送邮箱验证码"/>
						<span></span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="emailvalistr" value=""/>
						<span></span>
					</td>
				</tr>
				<tr>
